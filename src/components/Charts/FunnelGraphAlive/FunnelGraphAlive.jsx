...
const FunnelGraphAlive = () => {
  ...
  const countPassengersAliveByEmbarked = () => {
    const embarkedData = {
      Cherbourg: 0,
      Queenstown: 0,
      Southampton: 0,
    ...
    infos.forEach((info) => {
      ...
      const isSurvived = info.Survived === 1;
  ...
  const embarkedData = countPassengersAliveByEmbarked();
  ...
  return (
    <div style={{ height: "400px" }}>
      <p className="w-10/12 mx-auto text-3xl font-bold text-blue-700">
        This graph show how many people were alive of each embarked place
      </p>
      <ResponsiveBar
        data={data}
        keys={["value"]}
...
export default FunnelGraphAlive;
